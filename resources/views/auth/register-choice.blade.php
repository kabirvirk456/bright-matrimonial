...
<div class="min-h-screen flex items-center justify-center px-2 md:px-8 bg-gradient-to-br from-[#FFF3E6] via-[#F4E6E7] to-[#E7D8D6] relative">
    ...
    <div class="relative z-10 w-full max-w-2xl bg-white rounded-3xl shadow-2xl flex flex-col items-center justify-center px-10 py-16">
        ...
        <h2 class="text-2xl font-bold mb-4 text-[#C63D0F] text-center">Register</h2>
        <div class="w-full flex flex-col gap-5 mt-4">
            <a href="{{ route('register.email') }}" class="bg-[#C63D0F] hover:bg-[#FFF056] hover:text-[#3B3738] text-white font-semibold rounded-xl px-6 py-3 shadow text-lg text-center transition">Register with Email</a>
            <a href="{{ route('register.otp') }}" class="bg-[#FFF056] hover:bg-[#C63D0F] text-[#3B3738] hover:text-white font-semibold rounded-xl px-6 py-3 shadow text-lg text-center transition">Register with Mobile OTP</a>
        </div>
